...
class _HealthScreenState extends State<HealthScreen> {
  static Future<HealthModel?> fetchhealthdata() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=5d698d7bb37b429e8ec04f4d9cf05a48";
    final response = await http.get(Uri.parse(url));
    print(response.body);
    if (response.statusCode == 200) {
      Map<String, dynamic> jsondata = jsonDecode(response.body);

      HealthModel healthModel = HealthModel.fromJson(jsondata);
