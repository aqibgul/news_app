...
class _EntertainmentScreenState extends State<EntertainmentScreen> {
  static Future<EntertainmentModel> fetchentertainmentdata() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=5d698d7bb37b429e8ec04f4d9cf05a48";
    ...
    if (response.statusCode == 200) {
      ...
      EntertainmentModel entertainmentModel =
          EntertainmentModel.fromJson(jsondata);
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Expanded(
              child: FutureBuilder(
                  future: fetchentertainmentdata(),
                  builder: (BuildContext context,
                      AsyncSnapshot<EntertainmentModel?> snapshot) {
                    if (!snapshot.hasData &&
